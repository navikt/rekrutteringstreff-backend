...
| 14.1.14 | Markedskontakt og veileder uten eierskap – Send tillegg/forslag direkte til `POST /api/rekrutteringstreff/{id}/jobbsoker` for WorkOp. Gjenta som eier, utvikler uten eierskap og ikke-eier av et vanlig treff. | WorkOp avviser ikke-eiere med 403 før kandidatoppslag og lagring, uten nye jobbsøkere eller hendelser. Eier med arbeidsgiverrettet eller jobbsøkerrettet rolle og utvikler uten eierskap får legge til. Vanlige treff beholder eksisterende rollebasert tilgang. | | |
