...
- [Teknologi og overordnet arkitektur](2-arkitektur/teknologi%20og%20overorndet%20arkitektur.md) - Viktigste teknologier (frontend + backend) og konseptuell flyt
