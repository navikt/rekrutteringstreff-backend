...
Markedskontakt endrer et publisert treff som allerede har inviterte jobbsøkere. Kan velge om det skal sendes varsel om endringen.
...
**Hva skjer:**
1. Treffdetaljer oppdateres i databasen
2. Aktivitetskort oppdateres med nye detaljer (tid, sted etc.)
3. Hvis MK velger å varsle: SMS/e-post sendes til inviterte + de som svarte ja
4. De som svarte nei får IKKE varsel om endring

| #   | Test                                          | Forventet resultat                                         |
| --- | --------------------------------------------- | ---------------------------------------------------------- |
| 7.1 | MK - Endre tittel, IKKE send varsel           | Tittel oppdateres, ingen varsel sendes                     |
| 7.2 | MK - Endre tidspunkt, send varsel             | Varsel sendes til inviterte + svart ja                     |
| 7.3 | MK - Endre sted, send varsel                  | Varsel sendes med info om endret sted                      |
| 7.4 | Jobbsøker (invitert) - Motta endringsvarsel   | SMS/e-post med info om hva som er endret                   |
| 7.5 | Jobbsøker (svart ja) - Motta endringsvarsel   | SMS/e-post med info om hva som er endret                   |
| 7.6 | Jobbsøker (svart nei) - Sjekk varsel          | Skal IKKE motta varsel                                     |
| 7.7 | Jobbsøker - Åpne treff etter endring          | Ser oppdaterte detaljer i rekrutteringstreff-bruker        |
| 7.8 | Jobbsøker - Sjekk aktivitetskort etter endring| Aktivitetskort har oppdaterte detaljer                     |
| 7.9 | Veileder - Sjekk aktivitetskort etter endring | Ser oppdaterte detaljer                                    |
...
Markedskontakt eller veileder legger til innlegg (oppdateringer) på treffet som jobbsøkere kan se.

**Hvor:**
- MK/Veileder: rekrutteringsbistand
...
| 10.3 | MK - Legg til flere innlegg                   | Alle innlegg vises i kronologisk rekkefølge                |
| 10.4 | MK - Slett innlegg                            | Innlegg fjernes fra visningen                              |
...
3. Resultatet logges i databasen med feltene "lagret" (om teksten ble brukt)
4. Administratorer kan se logg og gjøre manuell kvalitetskontroll
...
| 14.6 | Veileder (ikke eier) - Prøv Hendelser-fanen   | Fanen er ikke tilgjengelig                                 |
