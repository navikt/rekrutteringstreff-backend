...
| #   | Test                                                      | Forventet resultat                          | Status | Notat |
| --- | --------------------------------------------------------- | ------------------------------------------- | ------ | ----- |
...
| Seksjon                            | Antall tester | OK  | Feilet | Ikke utført |
| ---------------------------------- | ------------- | --- | ------ | ----------- |
| 1. Opprette rekrutteringstreff     | 10            |     |        |             |
| 2. Legge til arbeidsgiver          | 7             |     |        |             |
| 3. Publisere rekrutteringstreff    | 3             |     |        |             |
| 4. Legge til jobbsøker             | 25            |     |        |             |
| 5. Invitere jobbsøker              | 13            |     |        |             |
| 6. Jobbsøker svarer på invitasjon  | 14            |     |        |             |
| 7. Endre publisert treff           | 13            |     |        |             |
| 8. Avlyse treff                    | 9             |     |        |             |
| 9. Treff gjennomføres og avsluttes | 7             |     |        |             |
| 10. Innlegg på treff               | 5             |     |        |             |
| 11. KI-moderering                  | 17            |     |        |             |
| 12. Søke etter rekrutteringstreff  | 4             |     |        |             |
| 13. Finn jobbsøkere (kandidatsøk)  | 6             |     |        |             |
| 14. Hendelseslogg                  | 8             |     |        |             |
| 15. Tilgangsstyring og roller      | 32            |     |        |             |
| **TOTALT**                         | **173**       |     |        |             |
...
- Tilgangsstyring - Teknisk dokumentasjon roller og tilgang
- Synlighet - Teknisk dokumentasjon synlighetsfiltrering
- Invitasjon - Teknisk flyt for invitasjon
- Varsling - Varslingsmekanismer og maler
- Aktivitetskort - Aktivitetskort-synkronisering
- MinSide-flyt - Jobbsøkerflyt og rekrutteringstreff-bruker
- KI-moderering - Teknisk dokumentasjon KI-validering og logging
