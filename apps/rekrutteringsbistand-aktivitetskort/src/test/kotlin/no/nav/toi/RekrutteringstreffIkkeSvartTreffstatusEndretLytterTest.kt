...
class RekrutteringstreffIkkeSvartTreffstatusEndretLytterTest {
    ...
    @Test
    fun `fullført treffstatus for ikke-svart bruker skal flytte aktivitetskort til avbrutt med NAVIDENT som endrer`() {
        testIkkeSvartTreffstatusEndret(
    ...
    @Test
    fun `avlyst treffstatus for ikke-svart bruker skal flytte aktivitetskort til avbrutt med NAVIDENT som endrer`() {
        testIkkeSvartTreffstatusEndret(
            treffstatus = "avlyst",
            forventetAktivitetsStatus = AktivitetsStatus.AVBRUTT,
            forventetEndretAvType = EndretAvType.NAVIDENT,
    ...
    @Test
    fun `Om treffstatus endres for ikke-svart bruker men aktivitetskort ikke finnes skal vi ikke feile`() {
    ...
    private fun testIkkeSvartTreffstatusEndret(
        treffstatus: String,
    ...
    private fun rapidMelding(
        ...
        {
            "@event_name": "ikkeSvartTreffstatusEndret",
            "fnr": "$fnr",
            "rekrutteringstreffId": "$rekrutteringstreffId",
            "treffstatus": "$treffstatus",
            "endretAv": "$endretAv",
