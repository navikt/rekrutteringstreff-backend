...
class AktivitetskortJobbsøkerSchedulerTest {
    ...
    fun `skal sende avlysningsvarsel kun til jobbsøkere som har svart ja - ikke til kun inviterte`() {
        ...
        // Verifiser at begge personer får avbrutt-status, men kun svart-ja får hendelseId (for varsling)
        ...
        // Person som svarte ja skal få avlyst-status med hendelseId (kandidatvarsel-api lytter på denne)
