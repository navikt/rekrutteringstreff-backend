...
class AktivitetskortFeilLytterTest {
    ...
    fun `skal lagre feil-hendelse når aktivitetskort-opprettelse feiler`() {
        ...
        rapid.sendTestMessage(
            """
            {
                "@event_name": "aktivitetskort-feil-rekrutteringstreff",
    ...
    @Deprecated("Testen er avhengig av eventnavn som er endret, fjern etter at eventnavn er endret")
    @Test
    fun `skal lagre feil-hendelse når aktivitetskort-opprettelse feiler deprekert, fjern etter eventnavn er endret`() {
        val rapid = TestRapid()
        AktivitetskortFeilLytter(rapid, jobbsøkerService)
