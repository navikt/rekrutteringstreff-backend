...
object SystemPrompt {
    const val versjonsnummer = 2
    private const val tidsstempelUtenSone = "2025-09-08T15:00:00"
    const val hash = "60919c"
    ...
    private const val VALIDATION_SYSTEM_MESSAGE = """
        ...
        Godta treff for flyktninger og ungdommer i aldersspennet 18-30 år, da dette skal være mulig å invitere de to gruppene. Dette er fordi det er satsningsområder i Nav. 
